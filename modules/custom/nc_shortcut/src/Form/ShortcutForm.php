...
/**
 * Implements a shortcut block config form
 */
class ShortcutForm extends ConfigFormBase {
    /**
     * {@inheritdoc}
     */
    public function getFormId() {
        return 'ncshortcut_config';
    }
    ...
    public function buildForm(array $form, FormStateInterface $form_state) {
        $config = $this->config('ncshortcut.config');
        ...
        $form = [
            'link1' => [
                ...
                'image' => [
                    '#type' => 'managed_file',
                    '#title' => 'Image',
                    '#upload_location' => 'public://modules/custom/shortcut',
    ...
    public function submitForm(array &$form, FormStateInterface $form_state) {
        ...
        $this->config('ncshortcut.config')
            ...
            ->set('link1.hide', $form_state->getValue('link1')['display'])
            ->save();
        ...
        $this->config('ncshortcut.config')
            ...
            ->set('link2.hide', $form_state->getValue('link2')['display'])
            ->save();
        ...
        $this->config('ncshortcut.config')
            ...
            ->set('link3.hide', $form_state->getValue('link3')['display'])
            ->save();
        ...
        $this->config('ncshortcut.config')
            ...
            ->set('link4.hide', $form_state->getValue('link4')['display'])
            ->save();
    }
}
